...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (nssCard && modal) {
       ...
       // IBM AI Fundamentals click handler
    const aiFundamentalsCard = document.getElementById("ai-fundamentals-cert-card");
    if (aiFundamentalsCard && modal) {
        aiFundamentalsCard.addEventListener("click", () => {
            modalTitle.textContent = "AI Fundamentals: Foundations for Understanding AI";
            modalOverview.textContent = "Issued by IBM SkillsBuild. This credential introduces foundational artificial intelligence concepts, core machine learning paradigms, history, and applications of AI in modern industry contexts.";
            
            modalFeatures.innerHTML = `
                <li><span class="feat-bullet">⚡</span> Artificial Intelligence (AI) Foundations</li>
                <li><span class="feat-bullet">⚡</span> Machine Learning Concepts</li>
                <li><span class="feat-bullet">⚡</span> Natural Language Processing (NLP)</li>
                <li><span class="feat-bullet">⚡</span> AI Ethics & Trust</li>
            `;
            ...
            // Show Demo button as Verify Link
            if (modalDemo) {
                modalDemo.setAttribute("href", "https://www.credly.com/go/7R9DU2H9");
                modalDemo.style.display = "";
                modalDemo.innerHTML = `
            ...
            // Show image section with certificate
            if (imgSection && modalProjectImg) {
                modalProjectImg.setAttribute("src", "assets/images/certificate.jpg");
                modalProjectImg.setAttribute("alt", "AI Fundamentals Certificate");
    ...
    // IBM Explore Emerging Tech click handler----------------------------------------------------------------------------------------------------
    const emergingTechCard = document.getElementById("emerging-tech-cert-card");
    if (emergingTechCard && modal) {
        emergingTechCard.addEventListener("click", () => {
            modalTitle.textContent = "Explore Emerging Tech";
            modalOverview.textContent = "Issued by IBM-SkillsBuild. This credential certifies foundational knowledge across today's essential technologies including artificial intelligence (AI), cybersecurity, data analysis, cloud computing, and quantum computing.";
            
            modalFeatures.innerHTML = `
                <li><span class="feat-bullet">⚡</span> Learning Artificial Intelligence (AI) & Deep Learning</li>
                <li><span class="feat-bullet">⚡</span> Career Exploration in Technology</li>
                <li><span class="feat-bullet">⚡</span> Cloud Computing, Deployment & Service Models</li>
                <li><span class="feat-bullet">⚡</span> Cybersecurity & Threat Identification</li>
                <li><span class="feat-bullet">⚡</span> Data Analysis & Data Management</li>
                <li><span class="feat-bullet">⚡</span> Machine Learning & Natural Language Processing (NLP)</li>
                <li><span class="feat-bullet">⚡</span> Quantum Computing Foundations</li>
                <li><span class="feat-bullet">⚡</span> Device and Data Protection</li>
            `;
            ...
            // Hide Git & Demo buttons
            if (modalGit) modalGit.style.display = "none";
            if (modalDemo) modalDemo.style.display = "none";
            
            // Show image section with certificate
            if (imgSection && modalProjectImg) {
                modalProjectImg.setAttribute("src", "assets/images/certificate2.jpg");
                modalProjectImg.setAttribute("alt", "Explore Emerging Tech Certificate");
                imgSection.style.display = "";
            }
